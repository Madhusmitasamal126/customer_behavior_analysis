...
--3. Which are the top 5 products with the highest average review rating?
 ...
 --5. Do subscribed customers spend more? compare average spend and totl revenue betwwen subscribers and non-subscribers.
...
--6. Which 5 products have the highest percentage of purchase with discounts applies?
...
--7. Segment customers into  New, Returning , and loyal based on their total number of previous puchases, and show the count of each segment
...
select item_rank, category, item_purchased,total_orders from item_counts where item_rank<=3;
 ...
 select age_group,
 sum(purchase_amount)as total_revenue from customer group by age_group order by total_revenue desc;
